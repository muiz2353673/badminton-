...
create table if not exists public.registrations (
  ...
  event text not null,
  partner_name text,
  partner_id uuid references public.registrations(id) on delete set null,
  standard text,
  notes text,
...
create table if not exists public.matches (
  ...
  player1_partner_id uuid references public.registrations(id) on delete set null,
  player2_id uuid references public.registrations(id) on delete set null,
  player2_partner_id uuid references public.registrations(id) on delete set null,
  score1 int,
  score2 int,
